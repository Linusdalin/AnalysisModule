...
public class DefinitionUsageExtractorEN extends DefinitionUsageExtractor implements FeatureExtractorInterface {


    public DefinitionUsageExtractorEN(){
    ...
    public void classify(AnalysisFragment fragment, AnalysisOutcome outcome, FeatureTypeTree tree){
        ...
        String tag = "Ambiguous Definition Usage";
