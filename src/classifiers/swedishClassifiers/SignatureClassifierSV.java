...
public class SignatureClassifierSV extends SignatureClassifier implements ClassifierInterface {
    ...
    public SignatureClassifierSV(){

        super(LanguageSpecificRuleList);
        keywords = "signatur underskrift";
        name = "Signatur";
